...
def userdata(User_id:str):
    ...
    items_usu_games = pd.read_csv(r'user_items.csv')
...
@app.get('/countreviews/{fecha_inicial},{echa_final}', response_class=HTMLResponse)
...
@app.get('/genre/{género}', response_class=HTMLResponse)
